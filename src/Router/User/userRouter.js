...
userRouter.post("/admin/login", userHandler.adminLoginHandler);
userRouter.post("/googleAuthAdmin", userHandler.googleAuthHandlerAdmin);
userRouter.post(
  "/githubAuthAdmin/:gitCode",
  userHandler.githubAuthHandlerAdmin
);
